...
import 'package:hooyim/generated/json/statistic_entity_helper.dart';
...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {
			...
			case StatisticEntity:
				return statisticEntityFromJson(data as StatisticEntity, json) as T;
			case StatisticResult:
				return statisticResultFromJson(data as StatisticResult, json) as T;
			case ArticleEntity:
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {
			...
			case StatisticEntity:
				return statisticEntityToJson(data as StatisticEntity);
			case StatisticResult:
				return statisticResultToJson(data as StatisticResult);
			case ArticleEntity:
  ...
  //Go back to a single instance by type
	static _fromJsonSingle<M>( json) {
		...
		}	else if(type == (StatisticEntity).toString()){
			return StatisticEntity().fromJson(json);
		}	else if(type == (StatisticResult).toString()){
			return StatisticResult().fromJson(json);
  ...
  //list is returned by type
	static M _getListChildType<M>(List data) {
		...
		}	else if(<StatisticEntity>[] is M){
			return data.map<StatisticEntity>((e) => StatisticEntity().fromJson(e)).toList() as M;
		}	else if(<StatisticResult>[] is M){
			return data.map<StatisticResult>((e) => StatisticResult().fromJson(e)).toList() as M;
